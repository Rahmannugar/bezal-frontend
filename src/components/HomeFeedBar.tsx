      ...
      <div className="bg-white p-7 min-w-[600px] w-[50vw] max-w-[100%] min-h-[674px] rounded-[20px] mt-10 shadow-md">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex items-center space-x-5">
            ...
            />
            <div>
              <h1 className="text-black font-semibold">John Doe</h1>
              <h1 className="text-sm text-[#AAAAAA]">15h</h1>
            </div>
          </div>

          {/* right top section */}
          <div className="flex items-center space-x-5">
            <h1 className="text-[#AAAAAA]">10k views</h1>
            <button>
              <svg
                width="15"
                height="35"
                viewBox="0 0 15 35"
                className="hover:fill-[#4385F5] fill-[#C4C4C4]"
                fill="none"
        ...
        <div className="flex justify-between items-center mt-7">
          <div className="flex items-center space-x-7">
            {/* like menu */}
            <div className="flex items-center space-x-3 text-[#5D5F63]">
              <button>
                <svg
                  width="21"
                  height="20"
            ...
            {/* comment menu */}
            <div className="flex items-center space-x-3 mt-1 text-[#5D5F63]">
              <button>
                <svg
                  width="21"
                  height="20"
          ...
          {/* tip option */}
          <div>
            <button className="text-[#5D5F63]">$ Tip</button>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-5 mt-5">
            ...
            {/* post textfield */}
            <textarea
              className=" min-h-[40px] w-full pt-3 resize-none border-none bg-white outline-none  placeholder-[#C5C7C8] text-black"
