  ...
  return (
    <div>
      ...
      <div
        ...
        } p-7 min-w-[600px] w-[50vw] max-w-[100%] min-h-[674px] rounded-[20px] mt-10 shadow-md`}
      >
        {/* user data */}
        <div className="flex justify-between">
          ...
          <div className="flex items-center space-x-5">
            ...
            <div>
              ...
              <h1
                className={` ${mode ? "text-[#AAAAAA]" : "text-white"} text-sm`}
              >
                15h
              </h1>
            </div>
        ...
        {/* view comments */}
        <div className="mt-5">
          <button className="text-[#4385F5]">View 100 comments</button>
        </div>
