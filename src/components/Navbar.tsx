...
const Navbar = () => {
  ...
  return (
    <nav className="hidden relative py-5 justify-between space-x-3 w-full items-center px-16">
      {/* App icon */}
      <a href="/">
        <svg
          width="96"
      ...
      {/* search field */}
      <div className="flex justify-start items-center space-x-1 w-[649px] h-[40px] px-5 py-3 border-[2px] border-gray-300 rounded-[10px] bg-white">
        <svg
